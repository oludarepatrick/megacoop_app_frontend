...
import { useInvestmentData, usePortfolioData, useTrendingStocks, useAvailableInvestments } from "@/hooks/useInvestment";

const Investment = () => {
    const { data: investmentData, isLoading, isError } = useInvestmentData();
    const { data: allInvestment} = useAvailableInvestments();
    ...
    return (
        <div className="font-poppins">
            ...
            <AvailableInvestments cards={allInvestment || []}/>
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 pt-4">
                <div className="lg:col-span-7 flex flex-col gap-5">
                    <InvestmentPortfolio investments={portfolioData} />
                </div>
                <div className="lg:col-span-5 flex flex-col gap-5">
                    <TrendingInvestment trendingStocks={trendingStocks} />
                </div>
            </div>
        </div>
    )
